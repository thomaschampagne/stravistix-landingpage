...
app.controller("BehaviourController", ['$scope', '$jQ', 'Fullpage', 'Swipebox', 'Animator', function($scope, $jQ, Fullpage, Swipebox, Animator) {
    ...
    $scope.verticalScrollInit = function() {
        ...
        Fullpage.init($scope.anchors, function afterLoad(anchorLink, pageIndex) {
            $scope.afterPageLoaded(anchorLink, pageIndex);
        });

        Swipebox.init();
    };

    $scope.afterPageLoaded = function(anchorLink, pageIndex) {

        // Landing download page
        if (anchorLink === 'downloadPage' && $scope.pageNotSeen(pageIndex)) {
        ...
        // Quote page
        if (anchorLink === 'quotePage' && $scope.pageNotSeen(pageIndex)) {
        ...
        // Preview pages
        var posistionOfPreviewAnchor = _.indexOf($scope.previewsAnchors, anchorLink);
        ...
        // And more...
        if (anchorLink === 'andMorePage' && $scope.pageNotSeen(pageIndex)) {
        ...
        // And more...
        if (anchorLink === 'donatePage' && $scope.pageNotSeen(pageIndex)) {
